...
function parseInstruction(instruction){
    ...
    if(operation==='+'){
        turnOn(startX, startY, finX, finY);
    }
    else if(operation==='-'){
        turnOff(startX, startY, finX, finY);
    }
    else if(operation==='*'){
        toggle(startX, startY, finX, finY);
    }
}

function turnOn(startX, startY, finX, finY){
    var start = startY*1000+startX;
    var end = finY*1000+finX;
...
function turnOff(startX, startY, finX, finY){
    var start = startY*1000+startX;
    var end = finY*1000+finX;
...
function toggle(startX, startY, finX, finY){
    var start = startY*1000+startX;
    var end = finY*1000+finX;
